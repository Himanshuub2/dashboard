...
const Home = ()=>{
    ...
    return(
        ...
        <div className="w-screen h-screen flex flex-row ">
          <div className="mobile:w-[20%] laptop:w-[30%] bg-black h-screen flex justify-center items-center">
            <h1 className="mobile:text-2xl laptop:text-6xl text-white font-medium font-headingText">Board.</h1>
          </div>
          {/* Right Side */}
          <div className="mobile:w-[78%] laptop:w-[70%] h-full bg-gray-200 flex flex-col items-center justify-center space-y-8">
            <Heading/>
            <div className="flex flex-row space-x-4">
            <button className="mobile:w-36 laptop:w-44 h-8 rounded-[1rem] bg-white text-[12px] mobile:text-[8px]"  onClick={()=>signIn("google",{callbackUrl:"https://dashboard-lx4s-himanshuub2.vercel.app/dashboard"})}>
            ...
            <button className="mobile:w-36 laptop:w-44 h-8 rounded-[1rem] bg-white px-2 mobile:text-[8px]">
