    ...
    return(
       <>
            <div className="flex flex-row justify-between items-center laptop:px-6 laptop:py-4 mobile:px-3 mobile:py-2 ">
                <h1 className="laptop:text-[1.3rem] mobile:text-[14px] font-semibold ">Todays Schedule</h1>
                <h1 className="text-gray-400 laptop:text-[12px] mobile:text-[10px]">See All
        ...
        
                {
                    meetingDetails.map(item=>(
                        <>
                            <div className="flex flex-row space-x-3 laptop:px-6 laptop:py-2 mobile:px-3 mobile:py-1 ">
                        <div className="">
                  {item.icon}
                </div>
                <div className="flex flex-col">
                    <p className="font-medium text-gray-700 mobile:text-[14px]">{item.subject}</p>
                    <p  className="text-gray-400 laptop:text-[12px] mobile:text-[10px]">{item.time}</p>
                    <p className="text-gray-400 laptop:text-[12px] mobile:text-[10px] mobile:mb-3">{item.venue}</p>
                </div>
                </div>
                </>
                    ))
